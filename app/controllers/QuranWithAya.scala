...
"114|6|Of the jinn and of mankind." 
 ...
 case List("1", verse, text) => List("The Opening", verse, text, "Meccan")
case List("2", verse, text) => List("The Calf, The Cow", verse, text, "Medinan")
case List("3", verse, text) => List("The Family of Imran, The House of 'Imrán", verse, text, "Medinan")
case List("4", verse, text) => List("The Women", verse, text, "Medinan")
case List("5", verse, text) => List("The Food, The Repast, The Table", verse, text, "Medinan")
case List("6", verse, text) => List("The Cattle", verse, text, "Meccan")
case List("7", verse, text) => List("The Heights, The Faculty of Discernment", verse, text, "Meccan")
case List("8", verse, text) => List("The Spoils of War", verse, text, "Medinan")
case List("9", verse, text) => List("The Repentance", verse, text, "Medinan")
case List("10", verse, text) => List("Jonah", verse, text, "Meccan")
case List("11", verse, text) => List("Hud", verse, text, "Meccan")
case List("12", verse, text) => List("Joseph", verse, text, "Meccan")
case List("13", verse, text) => List("The Thunder", verse, text, "Medinan")
case List("14", verse, text) => List("Abraham", verse, text, "Meccan")
case List("15", verse, text) => List("The Rocky Tract, The Stoneland, The Rock City, Al-Hijr", verse, text, "Meccan")
case List("16", verse, text) => List("The Honey Bees, The Bee", verse, text, "Meccan")
case List("17", verse, text) => List("The Night Journey", verse, text, "Meccan")
case List("18", verse, text) => List("The Cave", verse, text, "Meccan")
case List("19", verse, text) => List("Mary", verse, text, "Meccan")
case List("20", verse, text) => List("Ta-Ha", verse, text, "Meccan")
case List("21", verse, text) => List("The Prophets", verse, text, "Meccan")
case List("22", verse, text) => List("The Pilgrimage", verse, text, "Medinan")
case List("23", verse, text) => List("The Believers", verse, text, "Meccan")
case List("24", verse, text) => List("The Light", verse, text, "Medinan")
case List("25", verse, text) => List("The Criterion, The Standard, The Standard of True and False", verse, text, "Meccan")
case List("26", verse, text) => List("The Poets", verse, text, "Meccan")
case List("27", verse, text) => List("The Ant, The Ants", verse, text, "Meccan")
case List("28", verse, text) => List("The Narrations, The Stories, The Story", verse, text, "Meccan")
case List("29", verse, text) => List("The Spider", verse, text, "Meccan")
case List("30", verse, text) => List("The Romans, The Byzantines", verse, text, "Meccan")
case List("31", verse, text) => List("Luqman", verse, text, "Meccan")
case List("32", verse, text) => List("The Prostration, Worship, Adoration", verse, text, "Meccan")
case List("33", verse, text) => List("The Clans, The Confederates, The Combined Forces", verse, text, "Medinan")
case List("34", verse, text) => List("Sheba", verse, text, "Meccan")
case List("35", verse, text) => List("The Originator", verse, text, "Meccan")
case List("36", verse, text) => List("Ya Seen", verse, text, "Meccan")
case List("37", verse, text) => List("Those Who Set The Ranks, Drawn Up In Ranks, Those Ranged in Ranks", verse, text, "Meccan")
case List("38", verse, text) => List("Sad", verse, text, "Meccan")
case List("39", verse, text) => List("The Crowds, The Troops, Throngs", verse, text, "Meccan")
case List("40", verse, text) => List("The Forgiver (God), Forgiving", verse, text, "Meccan")
case List("41", verse, text) => List("Expounded, Explained In Detail, Clearly Spelled Out", verse, text, "Meccan")
case List("42", verse, text) => List("The Consultation", verse, text, "Meccan")
case List("43", verse, text) => List("The Gold Adornments, The Ornaments of Gold, Luxury, Gold", verse, text, "Meccan")
case List("44", verse, text) => List("The Smoke", verse, text, "Meccan")
case List("45", verse, text) => List("The Kneeling Down, Crouching", verse, text, "Meccan")
case List("46", verse, text) => List("Winding Sand-tracts, The Dunes, The Sand-Dunes", verse, text, "Meccan")
case List("47", verse, text) => List("Muhammad", verse, text, "Medinan")
case List("48", verse, text) => List("The Victory, Conquest", verse, text, "Medinan")
case List("49", verse, text) => List("The Private Apartments, The Inner Apartments", verse, text, "Medinan")
case List("50", verse, text) => List("Qaf", verse, text, "Meccan")
case List("51", verse, text) => List("The Wind That Scatter, The Winnowing Winds, The Dust-Scattering Winds", verse, text, "Meccan")
case List("52", verse, text) => List("The Mount, Mount Sinai", verse, text, "Meccan")
case List("53", verse, text) => List("The Star, The Unfolding", verse, text, "Meccan")
case List("54", verse, text) => List("The Moon", verse, text, "Meccan")
case List("55", verse, text) => List("The Most Merciful, The Most Gracious", verse, text, "Medinan")
case List("56", verse, text) => List("The Inevitable, The Event, That Which Must Come to Pass", verse, text, "Meccan")
case List("57", verse, text) => List("The Iron", verse, text, "Medinan")
case List("58", verse, text) => List("The Pleading, The Pleading Woman", verse, text, "Medinan")
case List("59", verse, text) => List("The Mustering, The Gathering, Exile, Banishment", verse, text, "Medinan")
case List("60", verse, text) => List("The Examined One, She That Is To Be Examined", verse, text, "Medinan")
case List("61", verse, text) => List("The Ranks, Battle Array", verse, text, "Medinan")
case List("62", verse, text) => List("The Congregation, Friday", verse, text, "Medinan")
case List("63", verse, text) => List("The Hypocrites", verse, text, "Medinan")
case List("64", verse, text) => List("The Cheating, The Mutual Disillusion, The Mutual Loss and Gain, Loss and Gain", verse, text, "Medinan")
case List("65", verse, text) => List("Divorce", verse, text, "Medinan")
case List("66", verse, text) => List("The Prohibition", verse, text, "Medinan")
case List("67", verse, text) => List("The Dominion, Sovereignty, Control", verse, text, "Meccan")
case List("68", verse, text) => List("The Pen", verse, text, "Meccan")
case List("69", verse, text) => List("The Sure Reality, The Laying-Bare of the Truth", verse, text, "Meccan")
case List("70", verse, text) => List("The Ways of Ascent, The Ascending Stairways", verse, text, "Meccan")
case List("71", verse, text) => List("Noah", verse, text, "Meccan")
case List("72", verse, text) => List("The Spirits, The Unseen Beings", verse, text, "Meccan")
case List("73", verse, text) => List("The Enfolded One, The Enshrouded One, Bundled Up, The Enwrapped One", verse, text, "Meccan")
case List("74", verse, text) => List("The One Wrapped Up, The Cloaked One, The Man Wearing A Cloak, The Enfolded One", verse, text, "Meccan")
case List("75", verse, text) => List("Resurrection, The Day of Resurrection, Rising Of The Dead", verse, text, "Meccan")
case List("76", verse, text) => List("The Human, Man", verse, text, "Medinan")
case List("77", verse, text) => List("Those Sent Forth, The Emissaries, Winds Sent Forth", verse, text, "Meccan")
case List("78", verse, text) => List("The Great News, The Announcement, The Tiding", verse, text, "Meccan")
case List("79", verse, text) => List("Those Who Tear Out, Those Who Drag Forth, Soul-snatchers, Those That Rise", verse, text, "Meccan")
case List("80", verse, text) => List("He Frowned", verse, text, "Meccan")
case List("81", verse, text) => List("The Folding Up, The Overthrowing, Shrouding in Darkness", verse, text, "Meccan")
case List("82", verse, text) => List("The Cleaving Asunder, Bursting Apart", verse, text, "Meccan")
case List("83", verse, text) => List("The Dealers in Fraud, Defrauding, The Cheats, Those Who Give Short Measure", verse, text, "Meccan")
case List("84", verse, text) => List("The Rending Asunder, The Sundering, Splitting Open, The Splitting Asunder", verse, text, "Meccan")
case List("85", verse, text) => List("The Mansions Of The Stars, Constellations, The Great Constellations", verse, text, "Meccan")
case List("86", verse, text) => List("The Night-Visitant, The Morning Star, The Nightcomer, That Which Comes in the Night", verse, text, "Meccan")
case List("87", verse, text) => List("The Most High, The All-Highest, Glory To Your Lord In The Highest", verse, text, "Meccan")
case List("88", verse, text) => List("The Overwhelming Event, The Overshadowing Event, The Pall", verse, text, "Meccan")
case List("89", verse, text) => List("The Break of Day, The Daybreak, The Dawn", verse, text, "Meccan")
case List("90", verse, text) => List("The City, The Land", verse, text, "Meccan")
case List("91", verse, text) => List("The Sun", verse, text, "Meccan")
case List("92", verse, text) => List("The Night", verse, text, "Meccan")
case List("93", verse, text) => List("The Glorious Morning Light, The Forenoon, Morning Hours, Morning Bright, The Bright Morning Hours", verse, text, "Meccan")
case List("94", verse, text) => List("The Expansion of Breast, Solace, Consolation, Relief, Patient, The Opening-Up of the Heart", verse, text, "Meccan")
case List("95", verse, text) => List("The Fig Tree, The Fig", verse, text, "Meccan")
case List("96", verse, text) => List("The Clinging Clot, Clot of Blood, The Germ-Cell", verse, text, "Meccan")
case List("97", verse, text) => List("The Night of Honor, The Night of Decree, Power, Fate, Destiny", verse, text, "Meccan")
case List("98", verse, text) => List("The Clear Evidence, The Evidence of the Truth", verse, text, "Medinan")
case List("99", verse, text) => List("The Earthquake", verse, text, "Medinan")
case List("100", verse, text) => List("The Courser, The Chargers, The War Horse", verse, text, "Meccan")
case List("101", verse, text) => List("The Striking Hour, The Great Calamity, The Stunning Blow, The Sudden Calamity", verse, text, "Meccan")
case List("102", verse, text) => List("The Piling Up, Rivalry in World Increase, Competition, Greed for More and More", verse, text, "Meccan")
case List("103", verse, text) => List("The Time, The Declining Day, The Epoch, The Flight of Time", verse, text, "Meccan")
case List("104", verse, text) => List("The Scandalmonger, The Traducer, The Gossipmonger, The Slanderer", verse, text, "Meccan")
case List("105", verse, text) => List("The Elephant", verse, text, "Meccan")
case List("106", verse, text) => List("Quraysh", verse, text, "Meccan")
case List("107", verse, text) => List("The Neighbourly Assistance, Small Kindnesses, Almsgiving, Assistance", verse, text, "Meccan")
case List("108", verse, text) => List("Abundance, Plenty, Good in Abundance", verse, text, "Meccan")
case List("109", verse, text) => List("The Disbelievers, The Kafirs, Those Who Deny the Truth", verse, text, "Meccan")
case List("110", verse, text) => List("The Help, Divine Support, Victory, Succour", verse, text, "Medinan")
case List("111", verse, text) => List("The Plaited Rope, The Palm Fibre, The Twisted Strands", verse, text, "Meccan")
case List("112", verse, text) => List("Purity of Faith, The Fidelity, The Declaration of [God's] Perfection", verse, text, "Meccan")
case List("113", verse, text) => List("The Daybreak, Dawn, The Rising Dawn", verse, text, "Meccan")
case List("114", verse, text) => List("Mankind, Men", verse, text, "Meccan")    
