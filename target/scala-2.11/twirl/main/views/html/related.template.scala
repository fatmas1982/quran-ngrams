...
<div class="container">
    <table class="table table-hover">
        ...
        """),_display_(/*34.10*/for((word, verses) <- repeated) yield /*34.41*/ {_display_(Seq[Any](format.raw/*34.43*/(""" """),format.raw/*34.44*/("""<tr>
            ...
            <td>"""),_display_(/*36.18*/for(List(chapter, versenum, word, versetxt, city) <- verses) yield /*36.78*/ {_display_(Seq[Any](format.raw/*36.80*/(""" """),_display_(/*36.82*/versetxt),format.raw/*36.90*/(""" """),format.raw/*36.91*/("""<br/> """)))}),format.raw/*36.98*/("""</td>            </tr>
            """)))}),format.raw/*37.14*/("""
...
object related extends related_Scope0.related
              /*
                  -- GENERATED --
                  DATE: Tue Jun 21 02:56:29 UTC 2016
                  SOURCE: /home/ubuntu/workspace/app/views/related.scala.html
                  HASH: 7241072681d17b12060891dcd7f5badc46b81927
                  MATRIX: 575->1|733->64|762->68|834->132|873->134|901->136|2280->1488|2327->1519|2367->1521|2396->1522|2445->1544|2470->1548|2520->1571|2596->1631|2636->1633|2665->1635|2694->1643|2723->1644|2761->1651|2828->1687|2860->1692
                  LINES: 20->1|25->1|27->3|27->3|27->3|29->5|58->34|58->34|58->34|58->34|59->35|59->35|60->36|60->36|60->36|60->36|60->36|60->36|60->36|61->37|62->38
                  -- GENERATED --
              */
